...
class Server(models.Model):
    class Meta:
        permissions = (
            ...
            ("can_Change_Point", "can_Change_class"),
            ("NutrilliteArticleManage", "NutrilliteArticleManage"),
            ("ArtistryArticleManage", "ArtistryArticleManage"),
            ("TechArticleManage", "TechArticleManage"),
            ("AmwayQueenArticleManage", "AmwayQueenArticleManage"),
