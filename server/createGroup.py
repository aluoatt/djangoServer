...
artistryArticleManager, created = Group.objects.get_or_create(name='artistryArticleManager')
if created:
...
nutrilliteArticleManager, created = Group.objects.get_or_create(name='nutrilliteArticleManager')
if created:
...
techArticleManager, created = Group.objects.get_or_create(name='techArticleManager')
if created:
...
amwayQueenArticleManager, created = Group.objects.get_or_create(name='amwayQueenArticleManager')
if created:
...
otherArticleManager, created = Group.objects.get_or_create(name='otherArticleManager')
if created:
...
chainyenArticleManager, created = Group.objects.get_or_create(name='chainyenArticleManager')
if created:
...
speechArticleManager, created = Group.objects.get_or_create(name='speechArticleManager')
if created:
...
# 文章管理大人
articleAdminManager, created = Group.objects.get_or_create(name='articleAdminManager')
if created:
